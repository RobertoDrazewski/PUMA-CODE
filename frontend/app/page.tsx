  ...
  return (
    ...
    >
      <div className="flex flex-col h-full">
        ...
        <div className={`grid transition-all duration-500 ease-in-out ${isExpanded ? 'grid-rows-[1fr] opacity-100 mt-4' : 'grid-rows-[0fr] opacity-0'}`}>
          <div className="overflow-hidden">
            ...
            <div className="relative w-full overflow-hidden rounded-2xl border border-white/10 shadow-2xl bg-black/50">
              {/* RUTA FINAL PARA RENDER: Raíz del public + Extensión .PNG en mayúsculas */}
              <img 
                src={`/${fileName}.PNG`} 
                alt={t[`s${num}_title`]}
                loading="lazy"
        ...
        {!isExpanded && (
          <span className="text-[10px] font-black text-blue-500/40 uppercase tracking-widest mt-4 animate-pulse">
            Click to expand
          </span>
        )}
      </div>
      ...
      <section className="min-h-screen flex flex-col items-center justify-center p-6 pt-32 text-center">
        <div className="max-w-4xl animate-in fade-in slide-in-from-bottom-6 duration-1000">
          ...
          <button 
            ...
            className="px-12 py-5 bg-blue-600 text-white rounded-full hover:bg-blue-500 transition-all duration-300 shadow-[0_0_40px_rgba(37,99,235,0.4)] font-black text-xl active:scale-95 flex items-center gap-3 mx-auto btn-futuristic"
          >
            {t.chat_button_start}
      ...
      <section id="contact" className="py-32 px-6 bg-gradient-to-t from-blue-900/10 to-black border-t border-white/5">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-6 md:gap-8">
            {/* Email */}
            <a href="mailto:info@puma-code.com" className="group flex items-center gap-4 px-10 py-5 bg-white text-black font-black rounded-3xl hover:bg-blue-600 hover:text-white transition-all duration-500 shadow-2xl active:scale-95 btn-futuristic">
            ...
            {/* LinkedIn */}
            <a href="https://www.linkedin.com/in/robert-drazewski" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-4 px-10 py-5 bg-[#0077b5] text-white font-black rounded-3xl hover:bg-[#005582] transition-all duration-500 shadow-2xl active:scale-95 btn-futuristic">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
              LinkedIn
            </a>

            {/* Instagram */}
            <a href="https://www.instagram.com/puma_code" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-4 px-10 py-5 bg-gradient-to-tr from-[#f09433] via-[#e6683c] via-[#dc2743] to-[#bc1888] text-white font-black rounded-3xl hover:scale-105 transition-all duration-500 shadow-2xl active:scale-95 btn-futuristic">
